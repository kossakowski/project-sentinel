...
def test_per_article_scales_only_the_prompt_and_adds_retries_and_repairs():
    row = per_article(report(2000, 1500, 260, CHEAP, invalid=0.1, not_polish=0.5), prompt_scale=2.0, prices=CHEAP)
    ...
    doubled = per_article(report(2000, 1500, 260, CHEAP, billed_ratio=2.0), prompt_scale=2.0, prices=CHEAP)
